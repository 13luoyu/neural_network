...
encoded_text_cls = encoded_text[:, 0, :]  # 整个输入语句的BERT表示
encoded_text_crane = encoded_text[:, 2, :]  # 为了评估一词多义词元“crane”，我们还打印出了该词元的BERT表示的前三个元素
print(encoded_text.shape, encoded_text_cls.shape, encoded_text_crane[0][:3])
# (1,6,128)，即(batch_size, 序列长, num_hiddens)
